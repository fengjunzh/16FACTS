Public Class length_limit
    ...
    Private _length_range_lower As Decimal
    Private _length_range_upper As Decimal
    ...
    Public Property Length_range_lower As Decimal
        Get
    ...
    Public Property Length_range_upper As Decimal
        Get
