...
Partial Public Class mode_phase_stationService
    Public Function Add(model As FACTS.Model.mode_phase_station) As Boolean
        Try
          ...
          New SqlParameter("@gen3", model.gen3)
            ...
            rowsAffected = SqlHelper.runProcedureWithAffectedRow("proc_mode_phase_station_Add", parameters)
            Return IIf(rowsAffected > 0, True, False)
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.Add()::" & ex.Message)
        End Try
    End Function
    Public Function AddReturnId(model As FACTS.Model.mode_phase_station) As Integer
        Try
            Dim rowsAffected As Integer
            Dim parameters As SqlParameter() = {
        New SqlParameter("@mode_id", model.mode_id),
        ...
        New SqlParameter("@gen3", model.gen3)
            ...
            Return SqlHelper.runProcedureWithReturnValue("proc_mode_phase_station_Add", parameters, rowsAffected)
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.AddReturnId()::" & ex.Message)
        End Try
    End Function
    Public Function Delete(id As Integer) As Boolean
        Try
            ...
            rowsAffected = SqlHelper.runProcedureWithAffectedRow("proc_mode_phase_station_DeleteRow", parameters)
            Return IIf(rowsAffected > 0, True, False)

        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.Delete()::" & ex.Message)
        End Try
    End Function
    Public Function Update(model As FACTS.Model.mode_phase_station) As Boolean
        Try
            Dim rowsAffected As Integer
            Dim parameters As SqlParameter() = {
        ...
        New SqlParameter("@gen3", model.gen3)
            ...
            rowsAffected = SqlHelper.runProcedureWithAffectedRow("proc_mode_phase_station_Update", parameters)
            Return IIf(rowsAffected > 0, True, False)
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.Update()::" & ex.Message)
        End Try
    End Function
    Public Function SelectAll() As List(Of FACTS.Model.mode_phase_station)
        Try
            Dim dt As DataTable
            Dim model As FACTS.Model.mode_phase_station
            Dim mlist As New List(Of FACTS.Model.mode_phase_station)

            Dim parameters As SqlParameter() = {}
            dt = SqlHelper.runProcedureWithDataset("proc_mode_phase_station_SelectAll", parameters, "dt").Tables("dt")

            If dt.Rows.Count = 0 Then Return Nothing

            For Each row As DataRow In dt.Rows
                model = New FACTS.Model.mode_phase_station
        ...
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.SelectAll()::" & ex.Message)
        End Try
    End Function
    Public Function SelectById(id As Integer) As FACTS.Model.mode_phase_station
        Try
            Dim dt As DataTable
            Dim model As New FACTS.Model.mode_phase_station
            Dim parameters As SqlParameter() = {
                                    New SqlParameter("@id", id)}

            dt = SqlHelper.runProcedureWithDataset("proc_mode_phase_station_SelectRow", parameters, "dt").Tables("dt")
            If dt.Rows.Count = 0 Then Return Nothing
        ...
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.SelectById()::" & ex.Message)
        End Try
    End Function
    Public Function SelectByWhere(whereString As String) As DataSet
        Try
            ...
            ds = SqlHelper.runProcedureWithDataset("proc_mode_phase_station_SelectByWhere", parameters, "dt")

            Return ds

        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.SelectByWhere()::" & ex.Message)
        End Try
    End Function
    Public Function DataRowToModel(row As DataRow) As FACTS.Model.mode_phase_station
        Try
            Dim model As New FACTS.Model.mode_phase_station
            ...
            Return model
        Catch ex As Exception
            Throw New Exception("mode_phase_station.DAL.DataRowToModel()::" & ex.Message)
        End Try
    End Function
End Class
