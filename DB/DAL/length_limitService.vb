...
Public Class length_limitService
	...
	Public Shared Function DataRowToModel(row As DataRow) As FACTS.Model.length_limit
		Try
			...
			If row.Table.Columns.Contains("length_range_lower") Then If Not (IsDBNull(row("length_range_lower"))) Then model.Length_range_lower = Convert.ToDecimal(row("length_range_lower"))
			If row.Table.Columns.Contains("length_range_upper") Then If Not (IsDBNull(row("length_range_upper"))) Then model.Length_range_upper = Convert.ToDecimal(row("length_range_upper"))
