...
Partial Public Class product_snService
    ...
    Public Function Add(model As FACTS.Model.product_sn) As Boolean
        Try
        ...
        End Try
    End Function
    Public Function AddReturnId(model As FACTS.Model.product_sn) As Integer
        Try
            Dim rowsAffected As Integer
            Dim parameters As SqlParameter() = {
        New SqlParameter("@product_main_id", model.product_main_id),
    ...
    Public Function Delete(id As Integer) As Boolean
        ...
        End Try
    End Function
    Public Function Update(model As FACTS.Model.product_sn) As Boolean
        Try
            Dim rowsAffected As Integer
            Dim parameters As SqlParameter() = {
        ...
        End Try
    End Function
    Public Function SelectAll() As List(Of FACTS.Model.product_sn)
        Try
            Dim dt As DataTable
            Dim model As FACTS.Model.product_sn
            Dim mlist As New List(Of FACTS.Model.product_sn)
            ...
            For Each row As DataRow In dt.Rows
                model = New FACTS.Model.product_sn
        ...
        End Try
    End Function
    Public Function SelectById(id As Integer) As FACTS.Model.product_sn
        Try
            Dim dt As DataTable
            Dim model As New FACTS.Model.product_sn
            Dim parameters As SqlParameter() = {
    ...
    Public Function SelectBySerialNum(product_serial_num As String) As Model.product_sn
        ...
        End Try
    End Function
    Public Function DataRowToModel(row As DataRow) As FACTS.Model.product_sn
        Try
            Dim model As New FACTS.Model.product_sn
