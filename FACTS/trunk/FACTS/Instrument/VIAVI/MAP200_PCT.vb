...
Public Class MAP200_PCT
    ...
    Private InstrType As InstrumentType = InstrumentType.MAP200_PCT
    ...
    Public Sub MeasStart() Implements IVIAVI.MeasStart
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.MeasStart()::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Sub MeasStop() Implements IVIAVI.MeasStop
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.MeasStop()::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Sub LaunchPCT() Implements IVIAVI.LaunchPCT
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.LaunchPCT()::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ''' 
    ...
    Public Sub ExitPCT() Implements IVIAVI.ExitPCT
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.ExitPCT()::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Sub FactoryCalMeasStart(stp As Integer) Implements IVIAVI.FactoryCalMeasStart
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.FactoryMeasStart()::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Sub FactoryCalMeasCommit(stp As Integer) Implements IVIAVI.FactoryCalMeasCommit
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.FactoryCalMeasCommit()::" & ex.Message)
        End Try
    End Sub
    ...
    Public Overloads Sub WaitOPC(timeOutSec As Integer) Implements IVIAVI.WaitOPC
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.WaitOPC()::" & ex.Message)
        End Try
    End Sub
    ...
    Public Overloads Sub Reset() Implements IVIAVI.Reset
        Try
            ...
            MyBase.Timeout = tmpTimeout
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.Reset()::" & ex.Message)
        End Try
    End Sub
    ...
    Public ReadOnly Property WavelengthAvailable As String Implements IVIAVI.WavelengthAvailable
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.Wavelength.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property ChannelAvailable As Integer Implements IVIAVI.ChannelAvailable
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.ChannelAvailable.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public Property Channel(group As Integer) As Integer Implements IVIAVI.Channel
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.Channel.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
                ...
                ActiveChannel = value
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.Channel.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property WavelengthList As String Implements IVIAVI.WavelengthList
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.WavelengthList.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As String)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.WavelengthList.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property MeasFunction As Integer Implements IVIAVI.MeasFunction
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasFunction.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasFunction.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property LaunchPort As Integer Implements IVIAVI.LaunchPort
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LaunchPort.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LaunchPort.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property MTJConnection As Integer Implements IVIAVI.MTJConnection
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MTJConnection.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MTJConnection.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property MeasState As MeasState Implements IVIAVI.MeasState
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasState.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property PCTState As Integer Implements IVIAVI.PCTState
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.PCTState.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property MeasResAll(Optional recChannel As Integer = 0) As String Implements IVIAVI.MeasResAll
        Get
            Try
                ...
                End If
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasResAll.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property CalibrationDate As Date Implements IVIAVI.CalibrationDate
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.CalibrationDate.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property FrontPanelDistance As String Implements IVIAVI.FrontPanelDistance
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.FrontPanelDistance.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property SwitchPathLength(channel As Integer) As String Implements IVIAVI.SwitchPathLength
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.SwitchPathLength.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public Property Wavelength As Integer Implements IVIAVI.Wavelength
        ...
        Set(value As Integer)
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.Wavelength.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property MeasRange As Integer Implements IVIAVI.MeasRange
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasRange.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasRange.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property ReceiveJumperUsage As Integer Implements IVIAVI.ReceiveJumperUsage
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.ReceiveJumperUsage.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.ReceiveJumperUsage.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property DUTLengthEstimated As Double Implements IVIAVI.DUTLengthEstimated
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.DUTLengthEstimated.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Double)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.DUTLengthEstimated.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property DUTLengthAuto As Boolean Implements IVIAVI.DUTLengthAuto
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.DUTLengthAuto.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Boolean)
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.DUTLengthAuto.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property JumperLengthOverrideValue(group As Integer) As Double Implements IVIAVI.JumperLengthOverrideValue
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperLengthOverrideValue.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Double)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperLengthOverrideValue.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property JumperLengthOverrideOption(group As Integer) As Integer Implements IVIAVI.JumperLengthOverrideOption
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperLengthOverrideOption.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperLengthOverrideOption.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property JumperILOverrideValue(group As Integer) As Double Implements IVIAVI.JumperILOverrideValue
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperILOverrideValue.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Double)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.JumperILOverrideValue.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Sub ResetJumperSetttings(group As Integer) Implements IVIAVI.ResetJumperSetttings
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.ResetJumperSetttings::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Property SelectChannelList(switch As Integer) As String Implements IVIAVI.SelectChannelList
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.SelectChannelList.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As String)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.SelectChannelList.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ...
    Public Property LiveMode As Integer Implements IVIAVI.LiveMode
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveMode.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveMode.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property LiveModePower As String Implements IVIAVI.LiveModePower
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveModePower.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property LiveModeLoss As String Implements IVIAVI.LiveModeLoss
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveModeLoss.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property LiveModeORL As String Implements IVIAVI.LiveModeORL
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveModeORL.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    Public ReadOnly Property LiveModeValue As String Implements IVIAVI.LiveModeValue
        Get
            Try
                Return MyBase.SendSCPIComand(":FETCh:LOSS?;:FETCh:ORL?;:FETCh:POWer?")
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.LiveModeValue.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ''' <summary>
    ...
    Public Property AverageTime As Integer Implements IVIAVI.AverageTime
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.AverageTime.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Integer)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.AverageTime.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public Property ILOnly As Boolean Implements IVIAVI.ILOnly
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.ILOnly.Get()::" & ex.Message)
            End Try
        End Get
        Set(value As Boolean)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.ILOnly.Set()::" & ex.Message)
            End Try
        End Set
    End Property
    ''' <summary>
    ...
    Public ReadOnly Property MeasPower As Double Implements IVIAVI.MeasPower
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasPower.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ...
    Public ReadOnly Property MeasLength As Double Implements IVIAVI.MeasLength
        Get
            ...
            Catch ex As Exception
                Throw New Exception("MAP200_PCT.MeasLength.Get()::" & ex.Message)
            End Try
        End Get
    End Property
    ...
    Public Sub SetLowerPowerMode() Implements IVIAVI.SetLowerPowerMode
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.ILOnly.SetLowerPowerMode()::" & ex.Message)
        End Try
    End Sub
    Public Sub ResetJumperMeasuredValue(group As Integer) Implements IVIAVI.ResetJumperMeasuredValue
        Try
            MyBase.SendSCPIComand(String.Format(":PATH:JUMPer:RESet:MEASure {0},(1)", group, ActiveChannel))
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.ResetJumperMeasuredValue::" & ex.Message)
        End Try
    End Sub
    ''' <summary>
    ...
    Public Sub MeasReset() Implements IVIAVI.MeasReset
        ...
        Catch ex As Exception
            Throw New Exception("MAP200_PCT.MeasReset::" & ex.Message)
        End Try
    End Sub
End Class
