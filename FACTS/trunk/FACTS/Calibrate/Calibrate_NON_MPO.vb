...
Public Class Calibrate_NON_MPO
    Inherits Calibrate
    ...
    Public Overrides ReadOnly Property CalItems As List(Of CalibrateItem)
        Get
            ...
            Catch ex As Exception
                Throw New Exception("Calibrate_NON_MPO.CalItems()::" & vbCrLf & " at " & ex.Message)
            End Try
        End Get
    End Property
    ...
    Public Overrides Function DoCal() As Boolean
        Try
            ...
            Return True
        Catch ex As Exception
            Throw New Exception("Calibrate_NON_MPO.DoCal() - " & ex.Message)
        End Try
    End Function
End Class
